...
export class PokemonSpecies {
  public static fromRawMaster(source: IPokemonTemplate, pokedexNumber: number, speciesName: string): PokemonSpecies {
    return new PokemonSpecies(source, pokedexNumber, speciesName, null);
  }

  public static fromParsed(source: PokemonSpecies): PokemonSpecies {
    return new PokemonSpecies(null, null, null, source);
  }
  ...
  private constructor(
    ...
    if (rawSource) {
      ...
      this.speciesName = speciesName as string;
